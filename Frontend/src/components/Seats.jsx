...
//   useEffect(() => {
//     if (selectedBus) {
//       const seats = Object.keys(selectedBus.seatStatus).map((key, index) => (
//         <div
//           key={index}
//           className={`w-10 h-10 rounded ${selectedBus.seatStatus[key] === "occupied" ? "bg-red-500" : "bg-green-500"
//             }`}
//         ></div>
//       ));
//       setSeatLayout(seats);
...
//     ? Object.values(selectedBus.seatStatus).filter((s) => s !== "occupied").length
//     : 0;
//   const totalSeats = selectedBus ? Object.keys(selectedBus.seatStatus).length : 0;
...
//           <select
//             onChange={(e) =>
//               setSelectedBus(buses.find((bus) => bus.busNumber === e.target.value))
//             }
//             className="p-2 rounded w-full text-black border-2 border-red-500"
...
//             Seat Layout
//           </h3>
//           <div className="grid grid-cols-5 gap-3 justify-items-center">{seatLayout}</div>
//         </article>
//         <article
//           className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg mr-10 w-full"
//           aria-labelledby="seat-info-title"
...
//           </p>
//           <p className="text-lg text-gray-700 dark:text-gray-300 ml-4">
//             <strong>Available:</strong> {availableSeats} / {totalSeats}
//           </p>
//         </article>
//       </div>
//     </section>
...
export default function Seats() {
  ...
  return (
    <div className="p-6">
      <h2 className="text-xl font-bold mb-4">Bus Seats</h2>
      <ul>
        {busData.map((bus, index) => (
          <li key={index} className="mb-2 border p-2 rounded">
            <p>Bus Number: {bus.busNumber}</p>
            <p>Seats: {JSON.stringify(bus.seatStatus)}</p>
          </li>
        ))}
      </ul>
    </div>
